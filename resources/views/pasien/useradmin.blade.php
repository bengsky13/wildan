            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail" placeholder="Masukkan Email" name="email" value="{{Auth::user()->alamat}}"disabled>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{route('dashboard_pasien')}}" class="btn btn-default">
                        Kembali
                    </a>
                </div>
            </div>
